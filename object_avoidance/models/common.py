...
from object_avoidance.utils import TryExcept
from object_avoidance.utils.dataloaders import exif_transpose, letterbox
...
from object_avoidance.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from object_avoidance.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from object_avoidance.export import export_formats
        from object_avoidance.utils.downloads import is_url
